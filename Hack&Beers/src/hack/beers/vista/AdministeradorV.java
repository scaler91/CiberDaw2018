 ...
 * @author Alumno
 */
public class AdministeradorV extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public AdministeradorV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministeradorV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdministeradorV dialog = new AdministeradorV(new javax.swing.JFrame(), true);
